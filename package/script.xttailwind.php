...
/*
 * @package     Tailwind CSS for Joomla Gantry
...
class Pkg_TailwindCssJoomlaGantryInstallerScript
{
    /**
     ...
     * @var string
     */
    protected $packageName = 'pkg_xtg5_tailwind';
